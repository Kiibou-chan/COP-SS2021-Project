...
<model ref="r:2927e85f-b64b-452e-b756-b84578e173bb(SoSeL21.structure)">
  ...
  <node concept="1TIwiD" id="4KVaSxxegQR">
    ...
    <node concept="1TJgyj" id="4KVaSxxegQW" role="1TKVEi">
      ...
      <ref role="20lvS9" node="77fYV$YdvD9" resolve="WorksheetLine" />
    </node>
  </node>
  ...
  <node concept="1TIwiD" id="77fYV$YdvD9">
    <property role="EcuMT" value="8201050219496208969" />
    <property role="TrG5h" value="WorksheetLine" />
    <property role="34LRSv" value="line" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
    <node concept="1TJgyj" id="77fYV$YdvDi" role="1TKVEi">
      <property role="IQ2ns" value="8201050219496208978" />
      <property role="20lmBu" value="fLJjDmT/aggregation" />
